...
/* ─── DIALOGUE SCRIPT ─── */
const DIALOGUE = [
{ at:0.04, who:'SENSEI MUGEN', text:'<em>Hmm.</em> So you finally crossed the line. Sit down, traveler — the road is long, and the blade is older than your grandfather.' },
{ at:0.11, who:'SENSEI MUGEN', text:'I am <strong>Mugen</strong>, ✦ keeper of unfinished worlds. This katana has cut the dreams of seventeen apprentices. Each returned home a craftsman.' },
{ at:0.18, who:'SENSEI MUGEN', text:'But none — <em>none</em> — became a builder of worlds. Few inherit the will. Fewer still answer it.' },
{ at:0.26, who:'SENSEI MUGEN', text:'Tell me, then. <strong>What world do you intend to build?</strong>' },
{ at:0.33, who:'sumofDanth', text:'<em>The one I cannot find on any map.</em>' },
{ at:0.45, who:'SENSEI MUGEN', text:'Good. Then the blade goes with you. Through cloud. Through thunder. Through the breaking of this old world.' },
{ at:0.62, who:'SENSEI MUGEN', text:'Every shard you see was once the shape of somebody else\'s dream. Step over them. The self is a hill with a sea behind it.' },
{ at:0.85, who:'SENSEI MUGEN', text:'Now look up. The dawn does not arrive — it is <em>answered</em>. Go on, builder. 世界を創る者.' },
];
